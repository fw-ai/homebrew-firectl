class Firectl < Formula
    ...
    sha256 "3d61231a927323ad39f68a6457a8be7f4fbc1f07503f921793600733ca2d0e16" # Linux
  
    if OS.mac? && Hardware::CPU.intel?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-amd64.gz"
      sha256 "bbd13111addd0550c84eecb2a036b081f90a9468ad6810c032b4b81bb3b82393" # Darwin AMD64
    elsif OS.mac? && Hardware::CPU.arm?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-arm64.gz"
      sha256 "09c7dada6fd193e0869724858968b206584135cfa06034fa887343abab752ecb" # Darwin ARM64
    end
