class Firectl < Formula
    ...
    sha256 "2ffe1bcfc6cb5b95c71d242c486aa6fc9a0a2a54b59a064985f6071cde5b704e" # Linux
  
    if OS.mac? && Hardware::CPU.intel?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-amd64.gz"
      sha256 "ccec4b6dad738d015b04832275c36d3f0558c633246eca4cd77dc1cdcbb6ce9e" # Darwin AMD64
    elsif OS.mac? && Hardware::CPU.arm?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-arm64.gz"
      sha256 "e291a0ad0b467f4347f49c6353cf7fb5075858e4476971ddb96cee555d3c04a3" # Darwin ARM64
    end
