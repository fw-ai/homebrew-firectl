class Firectl < Formula
    ...
    sha256 "e2ab6eb78d77ffd33f05c56f8c29ed73bd9dc1ff1b7b97794d0b6dc13f344c5e" # Linux
  
    if OS.mac? && Hardware::CPU.intel?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-amd64.gz"
      sha256 "903706fcef5569188eea91059e13d5c68b8e879642d96efed802145ef5fec141" # Darwin AMD64
    elsif OS.mac? && Hardware::CPU.arm?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-arm64.gz"
      sha256 "3684f9f74de5abd5d016c4016b5ec806255a9917251b5739106a31015b47895e" # Darwin ARM64
    end
