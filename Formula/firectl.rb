class Firectl < Formula
    ...
    sha256 "73910e755f9a20564abeefee89db800cd99fac8f5c6c39402691bee4692d8966" # Linux
  
    if OS.mac? && Hardware::CPU.intel?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-amd64.gz"
      sha256 "be2f03c8e06dea70f10db99bb3fe1f8fcf8e8eb32dfd131cffab5f325cdf78fb" # Darwin AMD64
    elsif OS.mac? && Hardware::CPU.arm?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-arm64.gz"
      sha256 "6a1c8857f5aca58b29584929d559d73fa5ddba002742a0b379e5682d379b2d2b" # Darwin ARM64
    end
