class Firectl < Formula
    ...
    sha256 "517398592d257c802746817ccb7e42ffdc98bcbc291adb1b8ad672db52f023d0" # Linux
  
    if OS.mac? && Hardware::CPU.intel?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-amd64.gz"
      sha256 "024a831f9d8dee437784fd3152b61f04ca717594c30df39ee59030fceaa28ffd" # Darwin AMD64
    elsif OS.mac? && Hardware::CPU.arm?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-arm64.gz"
      sha256 "c318c77e7e5565cf9dc0474c3d633cb541af8ecc68e77989667f36f82235c153" # Darwin ARM64
    end
