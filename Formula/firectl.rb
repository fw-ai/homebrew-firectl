class Firectl < Formula
    ...
    sha256 "454709d746b9a37eac634ee8a14bddeb7e4fa0868a58fdbef3561f8edccfa09a" # Linux
  
    if OS.mac? && Hardware::CPU.intel?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-amd64.gz"
      sha256 "348ff695dd6afac580b9d051d8016f564f7c650b0f0911f2667c5e1d0a792e8a" # Darwin AMD64
    elsif OS.mac? && Hardware::CPU.arm?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-arm64.gz"
      sha256 "d56bb872e0ee9f9ea10bd27f1e32cecfbfb089611f977546446813f18dc59e23" # Darwin ARM64
    end
