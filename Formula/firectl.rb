class Firectl < Formula
    ...
    sha256 "b18066acf8b95a15ffd73717baeeeffad7ed0759fb112b0d207fec7b74d70e6f" # Linux
  
    if OS.mac? && Hardware::CPU.intel?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-amd64.gz"
      sha256 "aa0b399e4192c79dc33d2adc6078873fecb827d3a5793ecee2d625a411195c37" # Darwin AMD64
    elsif OS.mac? && Hardware::CPU.arm?
      url "https://storage.googleapis.com/fireworks-public/firectl/stable/darwin-arm64.gz"
      sha256 "13224e6bde64336e20de89b91c8cb0350f54684d832025f9d81a2091dcbf1552" # Darwin ARM64
    end
